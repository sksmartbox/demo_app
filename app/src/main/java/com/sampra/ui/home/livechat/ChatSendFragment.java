 ...
 */
public class ChatSendFragment extends Fragment implements View.OnClickListener,EasyPermissions.PermissionCallbacks {
        ...
        if (picturePath != null)
        {
            ...
            call.enqueue(new Callback<UpdateProfileModel>() {
                ...
                public void onResponse(Call<UpdateProfileModel> call, Response<UpdateProfileModel> response) {
                    ...
                    SharedPref.write("is_login",response.body().getStatus());
