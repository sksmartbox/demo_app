...
import com.sampra.ui.home.news.all.AllNewsFragementNavigator;
...
public class FacebookViewModel extends BaseViewModel<FacebookFragementNavigator> {
    ...
    public void getAll(String type, String page){
        getCompositeDisposable().add(
                getDataManager().facebook(type,page)
